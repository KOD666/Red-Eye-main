...
export default function App() {
  ...
  const c2BaseUrl = `https://api.desaivraj.site`;
                    ...
                    <div style={{ padding: '15px', display: 'flex', flexDirection: 'column', gap: '10px', background: '#0d0d0e', borderRadius: '4px', border: '1px solid var(--border-subtle)' }}>
                      ...
                      <div style={{ marginLeft: '20px', borderLeft: '2px dashed var(--border-subtle)', paddingLeft: '20px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          <span style={{ fontSize: '11px', color: 'var(--accent-cyan)' }}>C2 Console: Host (https://api.desaivraj.site)</span>
                        </div>
                  ...
                  <div className="hud-panel">
                    ...
                    <div className="tbl-wrap" style={{ margin: 0, border: 'none' }}>
                      <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                        ...
                        <tbody>
                          {[
                            { ip: 'api.desaivraj.site', mac: 'C0:94:AD:CF:87:5A', vendor: 'gpon.net (zte)', type: 'Gateway', port: 'Uplink-Trunk', status: 'N/A' },
                            { ip: 'api.desaivraj.site', mac: 'BA:62:E3:13:45:F1', vendor: 'realme-5i', type: 'WLAN Device', port: 'Wi-Fi-2.4G', status: 'UNMANAGED' },
                            { ip: 'api.desaivraj.site', mac: 'BA:8D:34:ED:00:7E', vendor: 'V2307', type: 'WLAN Device', port: 'Wi-Fi-5G', status: 'UNMANAGED' },
                            { ip: 'api.desaivraj.site', mac: '14:D4:24:8F:6C:6D', vendor: 'Vraj (C2 Controller Host)', type: 'Management Console', port: 'Switch-Port-1', status: 'N/A' },
                            ...agents.map(a => ({
                              ip: a.ip_address,
